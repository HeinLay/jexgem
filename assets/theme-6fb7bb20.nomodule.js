    ...
    `);
      ...
      register('announcement-bar', {
        ...
        onLoad() {
          ...
          if (announcements.length > 1) {
            module.import('./index-ed9e8322.nomodule.js').then(function (n) { return n.i; }).then(({
              default: Flickity
            }) => {
      ...
      */
      ...
      register('video', {
        ...
        onLoad() {
          module.import('./fluorescent-video.es-b2740b93.nomodule.js').then(({
            default: Video
          }) => {
      ...
      const filterHandler = ({
        ...
        let filters = null;
        let delegate = null;
        module.import('./filtering-ee765254.nomodule.js').then(({
          default: filtering
        }) => {
      ...
      window.SHA = '6c545e04a6';

    })
  };
}));
//# sourceMappingURL=theme-6fb7bb20.nomodule.js.map
