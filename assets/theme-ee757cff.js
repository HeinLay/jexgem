...
register('announcement-bar', {
  ...
  onLoad() {
    ...
    if (announcements.length > 1) {
      import('./index-8a828623.js').then(function (n) { return n.i; }).then(({
        default: Flickity
      }) => {
...
register('video', {
  ...
  onLoad() {
    import('./fluorescent-video.es-654d4772.js').then(({
      default: Video
    }) => {
...
const filterHandler = ({
  ...
  let filters = null;
  let delegate = null;
  import('./filtering-90073dac.js').then(({
    default: filtering
  }) => {
...
//# sourceMappingURL=theme-ee757cff.js.map
